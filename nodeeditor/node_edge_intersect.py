...
class EdgeIntersect:
    ...
    def dropNode(self, node: "Node", scene_pos_x: float, scene_pos_y: float):
        ...
        e = self.grScene.scene.getEdgeClass()
        e(self.grScene.scene, socket_start, new_node_socket_in, edge_type=edge_type)
        new_node_socket_out = node.outputs[0]
        e(self.grScene.scene, new_node_socket_out, socket_end, edge_type=edge_type)
